...
class ProductUserController extends Controller
{
    public function redeemList()
    {
        ...
        return view('employee.product.redeem_list.index', compact('products'));
    }
    ...
    public function redeemTypeList($redeem_type)
    {
        ...
        return view('employee.product.redeem_list.create_redeem_list_type', compact('redeem'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('employee.product.redeem_list.edit', compact('redeem', 'p'));
    }
    ...
    public function detail($product)
    {
        ...
        return view('employee.product.redeem_list.detail')->withProduct($redeem->load(['user', 'product.image', 'image']));
    }
