              ...
              <ul class="nav flex-column sub-menu">
                 ...
                 @foreach($menu->childs as $child)
                  ...
                  @if($child->is_active == 1)
                   ...
                   @if($child->name != 'Transaksi' && $child->name != 'push notifikasi' && $child->name != 'Alasan Refund' && $child->name != 'penginapan' && $child->name != 'tipe kamar' && $child->name != 'fasilitas' && $child->name != 'nomor kamar')
