        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    {{ Form::model($user, array('route' => array('users.update.employee', $user->id), 'method' => 'PUT', 'files' => true)) }}{{-- Form model binding to automatically populate our fields with user data --}}
