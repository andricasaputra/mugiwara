...
@section('scripts')
  ...
  <script>
    ...
    const orderUrl = '{{ route('employee.dashboard.orderchart') }}';
    const pointUrl = '{{ route('employee.dashboard.pointchart') }}';
    const financeUrl = '{{ route('employee.dashboard.financechart') }}';
  </script>
