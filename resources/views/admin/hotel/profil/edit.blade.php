...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            @endif
            <h4 class="card-title">Form Ubah Hotel</h4>
            <form action="{{ route('admin.hotel.update') }}" enctype="multipart/form-data" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="number" max="5" min="1" class="form-control" id="ratings" name="ratings" value="{{ $hotel->ratings }}" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="regency_id" id="regency_id" class="form-control select2" required>
                                ...
                                <option value="{{ $regency->id }}" {{ $regency->id == $hotel->regency_id ? 'selected' : '' }}>{{ $regency->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
