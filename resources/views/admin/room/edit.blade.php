...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            ...
            <form action="{{ route('admin.room.update') }}" enctype="multipart/form-data" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="discount" name="discount" value="{{ $room->discount }}" required>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="form-group">
