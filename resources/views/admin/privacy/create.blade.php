                ...
                <div class="card-block">
                    ...
                    <form  method="post" action="{{ route('privacy.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input name="title" type="text" class="form-control form-control-lg"  required value="Kebijakan privasi aplikasi capsule inn">
                        </div>

                        <div class="form-group">
                           <label for="type">Isi Kebijakan Privasi</label>
                            <textarea name="body" id="editor" name="body"></textarea>
                        </div>
