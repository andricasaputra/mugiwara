        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                    ...
                    <hr>
                    <form  method="post" action="{{ route('admin.order.offline.store') }}">
                        @csrf
                        ...
                        <a href="{{ route('admin.order.offline.index') }}" class="btn btn-danger">Kembali</a>
...
<script>
    $(document).ready(function(){
        ...
        $('#room_id').on('change', function(){
            ...
            $.ajax({
                url : '{{ route('admin.order.offline.room.data') }}',
                method: 'POST',
                headers : {
